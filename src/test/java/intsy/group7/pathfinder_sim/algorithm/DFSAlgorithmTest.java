...
public class DFSAlgorithmTest implements AlgorithmTest {

    private final int testRuns;

    public DFSAlgorithmTest(int testRuns) {
        this.testRuns = testRuns;
    }

    /**
     * Runs the DFS algorithm 5 times and returns the average time and memory usage.
     *
    ...
    public Result testTimeComplexity(Node start, Node goal) {
        ...
        for (int i = 0; i < testRuns + 1; i++) {
            ...
            // Run DFS algorithm
            finalResult = DFSAlgorithm.DFS(start, goal);
