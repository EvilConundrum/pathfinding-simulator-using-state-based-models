...
public class BFSAlgorithmTest implements AlgorithmTest {

    private final int testRuns;

    public BFSAlgorithmTest(int testRuns) {
        this.testRuns = testRuns;
    }

    /**
     * Runs the BFS algorithm 5 times and returns the average time and memory usage.
     *
    ...
    public Result testTimeComplexity(Node start, Node goal) {
        ...
        for (int i = 0; i < testRuns + 1; i++) {
            ...
            // Run BFS algorithm
            finalResult = BFSAlgorithm.BFS(start, goal);
